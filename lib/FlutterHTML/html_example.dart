...
<p id='top'><a href='#bottom'>Scroll to bottom</a></p>
      ...
      <table style="background-color: red; padding: 10px 10px 10px 10px;">
        <colgroup>
          <col width="50%" />
          <col span="2" width="25%" />
        </colgroup>
        ...
        <tbody style="">
          <tr>
            <td rowspan='2'>Rowspan<br>Rowspan<br>Rowspan<br>Rowspan<br>Rowspan<br>Rowspan<br>Rowspan<br>Rowspan<br>Rowspan<br>Rowspan</td>
            <td>Data</td>
            <td>Data</td>
          </tr>
          <tr>
      ...
      <h3>Link support:</h3>
      <p>
        Linking to <a href='https://fluttergems.dev/html-css/'>websites</a> has never been easier.
      </p>
      <h3>Image support:</h3>
      <h3>Network png</h3>
...
class _HTMLExampleState extends State<HTMLExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('flutter_widget_from_html Example'),
        centerTitle: true,
      ),
